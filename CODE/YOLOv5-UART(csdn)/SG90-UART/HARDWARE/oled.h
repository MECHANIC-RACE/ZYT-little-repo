...
#define OLED0561_ADD	0x78  // OLED基地址
#define COM			0x00  // OLED 写命令
#define DAT 			0x40  // OLED 写数据
...
void OLED_DrawGIF(unsigned char x0, unsigned char y0,unsigned char x1, unsigned char y1, unsigned char k, int m, unsigned char GIF[][m]);	//显示动图
