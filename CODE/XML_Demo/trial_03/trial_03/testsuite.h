/** @file
 *    @brief MAVLink comm protocol testsuite generated from trial_03.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef TRIAL_03_TESTSUITE_H
#define TRIAL_03_TESTSUITE_H
...
static void mavlink_test_trial_03(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_trial_03(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_trial_03(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
