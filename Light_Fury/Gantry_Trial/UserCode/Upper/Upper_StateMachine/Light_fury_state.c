 ...
 * @LastEditors: ZYT
 * @LastEditTime: 2024-07-21 14:10:16
    ...
    ******距离变量******/
    ...
    for (;;) {
        ...
        }else if (stateflag==3)     //夹取短区的砝码
        {
            ...
            stateflag = 4;
        }else if (stateflag==4)         //往前滑行一段吸上砝码
        {
            ...
            if (weight_placement[0] == 0 && weight_placement[1] == 1) // 1区在外 2区在内------------->后抓内圈的2区 即right
            {
                LightFury.gantry_t.position.x  = 1;
                //LightFury.gantry_t.position.yL = 1;
                LightFury.gantry_t.position.yR = 1;
        ...
        } else if (stateflag == 9) // 往前滑行一段吸上砝码
        {
            ...
            osDelay(500);
            stateflag = 10;
        } else if (stateflag == 10) {                                  // 一内一外的情况
            if (weight_placement[3] == 1 && weight_placement[2] == 0) // 4区在内 3区在外------------->后抓外圈的2区 即left
            {
                LightFury.gantry_t.position.x  = 1;
                LightFury.gantry_t.position.yL = 1;
                // LightFury.gantry_t.position.yR = 1;
            ...
            if (weight_placement[3] == 0 && weight_placement[2] == 1) // 4区在外 3区在内------------->后抓内圈的3区 即right
            {
                LightFury.gantry_t.position.x = 1;
                // LightFury.gantry_t.position.yL = 1;
                LightFury.gantry_t.position.yR = 1;
