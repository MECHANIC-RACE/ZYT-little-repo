    ...
    if(1){      /*雷达状态正常*/
        ...
        /*前往木桩*/
            ...
            if(detect02ytree==0){
                ...
                Core_xy[1].gantry_t.position.y = -2950; //wangle 记得再验证一下
            }
            TickType_t StartTick = xTaskGetTickCount();
            initial_pos02[1]       = Core_xy[1].Motor_Y->AxisData.AxisAngle_inDegree;
            _Bool isArray1       = 0;
        ...
        }else if (stateflag == 6)
        {
            ...
            stateflag = 7;
                ...
                Core_xy[0].gantry_t.position.x = -17200;
                ...
                do {
                    TickType_t CurrentTick = xTaskGetTickCount();
                    float current_time     = (CurrentTick - StartTick) * 1.0 / 1000.0;
                    VelocityPlanning(initial_pos02[0], X_maxvelocity, X_Acceleration, Core_xy[0].gantry_t.position.x, current_time, &(current_pos01[0]));
